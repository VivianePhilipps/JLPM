#' @export
expectancy <- function(x, event, cond=NULL, newdata, var.time, start=0, nMC=1000, upper=150, subdivisions=100L, rel.tol=.Machine$double.eps^0.25)
{
    ...
    res1 <- integrate(f=fctprobVect, lower=start, upper=upper, s=start, x=x, newdata=newdata1, Y=Y,
